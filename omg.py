...
bot = telebot.TeleBot('8119765146:AAEXyY4_KBcf-WG1zu2gSwVt_vT0WKe8xn4')
...
def show_recent_logs(message):
    ...
    if user_id in admin_id:
        ...
        response = "⛔️ 𝗔𝗰𝗰𝗲𝘀𝘀 𝗗𝗲𝗻𝗶𝗲𝗱: 𝗔𝗱𝗺𝗶𝗻 𝗼𝗻𝗹𝘆 𝗰𝗼𝗺𝗺𝗮𝗻𝗱 DM TO BUY @God_x_Sikandar"
        bot.reply_to(message, response)
...
def status_command(message):
    ...
    if user_id in admin_id:
        ...
        bot.reply_to(message, "⛔️ 𝗬𝗼𝘂 𝗮𝗿𝗲 𝗻𝗼𝘁 𝗮𝗻 𝗮𝗱𝗺𝗶𝗻 @God_x_Sikandar.")
...
def upload_to_terminal(message):
    """Handle file upload to terminal for admins @God_x_Sikandar."""
    user_id = str(message.chat.id)
...
def add_user_command(message):
    if str(message.chat.id) not in admin_id:
        bot.reply_to(message, "⛔ 𝗔𝗰𝗰𝗲𝘀𝘀 𝗗𝗲𝗻𝗶𝗲𝗱: 𝗔𝗱𝗺𝗶𝗻 𝗼𝗻𝗹𝘆 𝗰𝗼𝗺𝗺𝗮𝗻𝗱 DM TO BUY @God_x_Sikandar DM TO BUY @God_x_Sikandar")
        return
...
def show_modify_options(message):
    if str(message.chat.id) not in admin_id:
        bot.reply_to(message, "⛔ 𝗔𝗰𝗰𝗲𝘀𝘀 𝗗𝗲𝗻𝗶𝗲𝗱: 𝗔𝗱𝗺𝗶𝗻 𝗼𝗻𝗹𝘆 𝗰𝗼𝗺𝗺𝗮𝗻𝗱 DM TO BUY @God_x_Sikandar")
        return
